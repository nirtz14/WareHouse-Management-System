...
class Volunteer {
    public:
        ...
        Volunteer(const Volunteer &other); // New copy constructor
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        CollectorVolunteer(const CollectorVolunteer &other); // New copy constructor
        CollectorVolunteer *clone() const override;
        void step() override;
        int getCoolDown() const;
        int getTimeLeft() const;
        void setTimeLeft(int timeLeft); // New
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        LimitedCollectorVolunteer(const LimitedCollectorVolunteer &other); // New copy constructor
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        DriverVolunteer(const DriverVolunteer &other); // New copy constructor
        DriverVolunteer *clone() const override;

        int getDistanceLeft() const;
        void setDistanceLeft(int distanceLeft);  // New
...
class LimitedDriverVolunteer: public DriverVolunteer {
    ...
    public:
        ...
        LimitedDriverVolunteer(const LimitedDriverVolunteer &other); // New copy constructor
